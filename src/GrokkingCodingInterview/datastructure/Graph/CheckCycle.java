...
class CheckCycle {
    public static boolean detectCycle1(Graph g){
    ...
    public static <T> boolean detectLoop(DoublyLinkedList<T> list) {
        DoublyLinkedList.Node slow = list.headNode;
        DoublyLinkedList.Node fast = list.headNode;
