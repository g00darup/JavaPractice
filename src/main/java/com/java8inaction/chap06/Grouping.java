package main.java.com.java8inaction.chap06;
...
public class Grouping {
    ...
    public static void main(String ... args) {
        ...
        //String shortMenu = menu.stream().collect(joining(", ")).toString();
    }
...
//        return (Map<Dish.Type, Set<String>>) menu.stream().collect(Grouping::groupDishTagsByType);
//    }
